...
//---------------------------------------
 ...
 respond.writeHead(200);
    ...
    if(path == '/home_movie_details'){//show all movies on db
        home_movie_details(url_query, respond);
    }
     ...
     //get data from db
        ...
        if(err){
           ...
           function db_data_shower(){
            ...
            respond.write("<p style='width:15em;height:20em;overflow:auto;background-color:black;color:white;display:inline-block;float:left;margin:1% 1% 1% 1.7%;opacity:0.9;border-radius:2%;background-image:url("+result[count].m_image+");background-size:contain;background-position:center;background-repeat:no-repeat'><a href='home_movie_details?"+result[count].movie_id+"' style='width:100%;height:10%;background-color:white;color:black'>"+result[count].m_title+"</a></p>");
         }
       }   
     );                  
  });
...
// https://c7.alamy.com/comp/F65WT1/terminator-genisys-year-2015-usa-director-alan-taylor-movie-poster-F65WT1.jpg
...
respond.write("<script>document.getElementById('heading').innerHTML ='DB Add data 2';</script>");
  ...
  console.log(data_to_write);
    //add data to db table
        ...
        //add data to db
        var mysql_db_data_add ="INSERT INTO movie_table (m_title, m_director, m_producer, m_production_company, m_country, m_actor, m_genre, m_description, m_disclaimer, m_image) VALUES ('"+data_to_write[0]+"','"+data_to_write[1]+"','" +data_to_write[2]+"','" +data_to_write[3]+"','" +data_to_write[4]+"','" +data_to_write[5]+"','" +data_to_write[6]+"','" +data_to_write[7]+"','" +data_to_write[8]+"','" +data_to_write[9]+"')";    
...
respond.write("<script>document.getElementById('heading').innerHTML ='Updating DB';</script>");
  ...
  console.log(data_to_write);
    //add data to db table
        ...
        //add data to db
        var mysql_db_data_add ="UPDATE movie_table SET m_title='"+data_to_write[0]+"', m_director='"+data_to_write[1]+"', m_producer='"+data_to_write[2]+"', m_production_company='" +data_to_write[3]+"', m_country='" +data_to_write[4]+"', m_actor='" +data_to_write[5]+"', m_genre='" +data_to_write[6]+"', m_description='" +data_to_write[7]+"', m_disclaimer='" +data_to_write[8]+"', m_image='" +data_to_write[9]+"' WHERE movie_id='"+data_to_write[10]+"'";    
